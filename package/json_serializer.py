...
class JsonSerializer:
    ...
    def decode_trade(self, src_str):
        json_trade = json.loads(src_str)
        local_trade = STradeData()        
        
        local_trade.time = json_trade["TimeArrive"];
        local_trade.exchange = json_trade["Exchange"];
        local_trade.symbol = json_trade["Symbol"];
        local_trade.sequence_no = json_trade["SequenceNo"]
